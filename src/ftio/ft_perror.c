...
/*   Updated: 2026/01/16 14:43:10 by khovakim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// error output (stderr). It is typically used to report errors or warnings in a
// program.
//
...
void ft_perror(const char* message) {
	...
	if (errno != 0) {
		...
		if (error_message) {
			...
			(void)!write(STDERR_FILENO, error_message,
