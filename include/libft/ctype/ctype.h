...
/**
 * @brief Checks whether the given integer value corresponds to an ASCII
 * character.
 *
 ...
 *
 * This function returns 1 if the input is an ASCII letter or digit (A-Z, a-z,
 * 0-9), 0 otherwise.
 *
 * @param  c The integer value to check.
 ...
 *
 * This function returns 1 if the input is an ASCII letter (A-Z, a-z), 0
 * otherwise.
 *
 * @param  c The integer value to check.
 ...
 *
 * This function returns 1 if the input is a printable ASCII character
 ...
 *
 * This function returns 1 if the input is a whitespace character (space, tab,
 * newline, vertical tab, form feed, carriage return), 0 otherwise.
 *
 * @param  c The integer value to check.
 ...
 *
 * If the input character is a lowercase letter (a-z), it is converted to
 * uppercase (A-Z). If the input is not a lowercase letter, it is returned
 * unchanged.
 *
 ...
 *
 * If the input character is an uppercase letter (A-Z), it is converted to
 * lowercase (a-z). If the input is not an uppercase letter, it is returned
 * unchanged.
 *
 * @param  c The integer value representing the character to convert.
 ...
 *
 * This function returns 1 if the input is a lowercase letter (a-z), 0
 * otherwise.
 *
 * @param  c The integer value to check.
 ...
 *
 * This function returns 1 if the input is an uppercase letter (A-Z), 0
 * otherwise.
 *
 * @param  c The integer value to check.
