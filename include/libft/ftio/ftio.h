 ...
 *
 * This function writes the specified error message to the standard error
 * output.
 *
 ...
 *
 * This function outputs the string 's' followed by a newline character to the
 ...
 * writes it to the specified file descriptor 'fd'.
 *
 ...
 *
 * This function writes the integer 'n' to the standard output (stdout) with
